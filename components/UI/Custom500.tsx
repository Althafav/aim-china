...
export default function Custom500() {
  const errorMessage = `Under Maintenance`;
  const text1 = `We'll Be Back in a few minutes!`;
  const text2 = `We’re making improvements and will be back shortly.`;
  const text3 = ` Apologies for the inconvenience—contact us through the channels
            below.`;
  return (
    <div className="page-not-found-wrapper">
      <div className="black-replacer-nav"></div>

      <div className="bg-500  pb-5">
        <div className="pd-5vw">
          <div>
            <div className="text-size-5-vh dpd-20 text-blue">
              {errorMessage}
            </div>
            <h1 className=" text-primary dpd-20">
              <strong>{text1}</strong>
            </h1>
          </div>
          ...
          <div>{text3}</div>
          <br />
          <div className="logos d-flex flex-wrap gap-2">
            <Link href="https://www.facebook.com/AIMCongress" target="_blank">
              <FaFacebook color="#099ffc" size={32} />
            </Link>
            ...
            <Link
              ...
              target="_blank"
            >
              <FaLinkedin color="#099ffc" size={32} />
            </Link>
            ...
            <Link
              ...
              target="_blank"
            >
              <FaInstagram color="#099ffc" size={32} />
            </Link>

            <Link href="https://www.threads.net/@aimcongress" target="_blank">
              <FaThreads color="#099ffc" size={32} />
            </Link>
            ...
            <Link
              ...
              target="_blank"
            >
              <FaYoutube color="#099ffc" size={32} />
            </Link>

            <Link href="https://x.com/AIM_Congress" target="_blank">
              <FaXTwitter color="#099ffc" size={32} />
            </Link>
