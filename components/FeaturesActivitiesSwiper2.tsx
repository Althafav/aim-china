...
interface FeaturesActivitiesSwiper2Props {
  heading: string;
  cards: Featuresactivitiesitem[] | any[];
}

export default function FeaturesActivitiesSwiper2({
  cards,
  heading,
}: FeaturesActivitiesSwiper2Props) {
  ...
  return (
    <div className="features-activities-home-section-wrapper">
      <div className="container">
        <div className="row">
          {/* Text Section */}
          <div className="col-12 col-md-6 p-4 mt-sm-5 ">
            ...
            >
              {cards.map((item: any, index: number) => (
                <SwiperSlide key={index}>
                  <img
                    className="feature-swiper-image"
