...
const CurrentSpeakerCarousel: React.FC<PageDataProps> = ({ pageData }) => {
    ...
    return (
        <div className='partner-carousel-wrapper'>
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h2 className='section-heading text-center'> {pageData.currentspeakersheading.value}</h2>
                    </div>
                </div>
            ...
            <div className="row mt-4">
                ...
                >
                    {pageData.currentspeakersitems.value.map((m: any, index: number) => {
                        var item: Speaker = m;
                        return (
                            <SwiperSlide
                                key={`speaker-item-${index}`}
                                className='key-players-card'>
...
export default CurrentSpeakerCarousel;
