...
(function () {
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      var PreferredSponsorshipPackage = $('input[name="field[366][]"]:checked')
        .map(function () {
          return $(this).val().trim();
        })
        .get();

      var PreferredTitleSponsorDetails =
        $('input[name="field[368]"]').val() || "N/A";

      var SponsorshipBudgetRange = $('select[name="field[365]"]').val();

      var TargetCountries = $("#focusedCountriesInput").length
        ? $("#focusedCountriesInput").val().trim()
        : "";

      var Expectations = $('textarea[name="field[6]"]').val();

      var SponsorsDetails = "";
      SponsorsDetails =
        SponsorsDetails +
        `Preferred Sponsorship Package: ${PreferredSponsorshipPackage}  || \n`;
      SponsorsDetails =
        SponsorsDetails +
        `Preferred Title Sponsor Details: ${PreferredTitleSponsorDetails}  || \n`;
      SponsorsDetails =
        SponsorsDetails +
        `Sponsorship Budget Range: ${SponsorshipBudgetRange}  || \n`;
      SponsorsDetails =
        SponsorsDetails + `Target Countries: ${TargetCountries}  || \n`;
      SponsorsDetails = SponsorsDetails + `Expectations: ${Expectations} `;
      ...
      <head>
        <style>
          ...
          .header { background-color: #099ffc; color: white; padding: 20px; text-align: center; }
        ...
        <div class="email-container">
          ...
          <div class="content">
            ...
            <table class="details-table">
              ...
              <tr>
                <th>Phone:</th>
                <td><a href="tel:${mobileText}">${mobileText}</a></td>
              </tr>
          ...
          <div class="footer">
            <p>This email was sent from the contact form on AIM Congress Team Page.</p>
            <p>© ${new Date().getFullYear()} AIM Congress. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
    `;
      const sender_email = "no-reply@aimcongress.com";
      const email_to = $('input[name="teamEmail"]').val();
      const subject = "AIM 2026 Lead";

      fetch("https://payment.aimcongress.com/api/Generic/SendEmail", {
        method: "POST",
        headers: {
