  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      if ($("#brochure").prop("checked") == true) {
        window.open(downloadFileLink.textContent, "_blank");
      }
      ...
      if (Expectations) {
        Expectations = Expectations.replaceAll("/", " ");
        Expectations = Expectations.replaceAll("\n", " ");
        Expectations = Expectations.replaceAll("\\", " ");
      }
      ...
      var portfolio = $('input[name="field[61][]"]:checked')
        .map(function () {
          return $(this).val().trim();
        })
        .get()
