 ...
 */
export class Awardpage2026 extends ContentItem {
    ...
    public awarditems!: Elements.LinkedItemsElement<ContentItem>;
    public juryheading!: Elements.TextElement;
    public juryitems!: Elements.LinkedItemsElement<ContentItem>;
    public ctacarditem!: Elements.LinkedItemsElement<ContentItem>;
